  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-0.5 mb-2.5 relative z-10">
        ...
        <span className="ml-1.5 text-[9px] text-amber-400/40 font-medium">5.0</span>
      </div>
...
export default function PeopleSay() {
  const containerRef = useRef(null);
  const isHeaderInView = useInView(containerRef, { once: true, margin: "-80px" });
      ...
      <div className="relative max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex w-max group/row1">
              ...
              >
                {[...firstRow, ...firstRow, ...firstRow].map((review, i) => (
                  <ReviewCard key={`r1-${review.id}-${i}`} review={review} index={i} />
                ))}
              </motion.div>
            </div>
            ...
            <div className="flex w-max group/row2">
              ...
              >
                {[...secondRow, ...secondRow, ...secondRow].map((review, i) => (
                  <ReviewCard key={`r2-${review.id}-${i}`} review={review} index={i} />
                ))}
              </motion.div>
            </div>
        ...
        >
          <div>
            ...
            <p className="text-[9px] text-slate-500/60 font-medium tracking-wide">Verified Reviews</p>
          </div>
          <div className="w-px h-5 bg-white/[0.03]" />
          <div>
            <p className="text-xl font-bold text-amber-400">5.0</p>
            <p className="text-[9px] text-slate-500/60 font-medium tracking-wide">Avg Rating</p>
          </div>
          <div className="w-px h-5 bg-white/[0.03]" />
          <div>
            <p className="text-xl font-bold text-white">100%</p>
            <p className="text-[9px] text-slate-500/60 font-medium tracking-wide">Satisfaction</p>
          </div>
        </motion.div>

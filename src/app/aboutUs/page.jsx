      ...
      <div className="max-w-[1140px] mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-[#B8B8C5] mt-6 leading-relaxed">
            At <span className="text-white font-semibold">BiblioDrop</span>, we believe that books are placeholders for identity, portals to new worlds, and tools for raw growth. Our mission is to bridge the gap between world-class literature and your reading desk effortlessly.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-28">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tight m-0">Our Core Vision</h2>
            </div>
            
            <p className="text-[#B8B8C5] leading-relaxed m-0">
              Founded with a passion for continuous learning and modern efficiency, BiblioDrop transforms traditional book purchasing into a luxury, personalized experience. We aren&apos;t just an e-commerce platform; we are a dedicated tech-ecosystem built for passionate readers, busy students, and lifelong researchers.
            </p>
            
            <p className="text-[#B8B8C5] leading-relaxed m-0">
              By combining robust logistics with an ultra-smooth dashboard, we ensure that the physical weight of a book is the only heavy lifting you ever have to experience.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 pt-4">
              {stats.map((stat, idx) => (
                <div key={idx} className="border-l-2 border-[#6D4AFF] pl-4">
                  <p className="text-2xl sm:text-3xl font-extrabold text-white m-0 tracking-tight">{stat.value}</p>
                  <p className="text-xs sm:text-sm text-[#B8B8C5] m-0 mt-0.5">{stat.label}</p>
                </div>
              ))}
            </div>
          </motion.div>
        ...
        <div className="border-t border-white/5 pt-20">
          ...
          >
            <h2 className="text-3xl font-bold tracking-tight m-0">Why Readers Choose BiblioDrop</h2>
            <p className="text-sm text-[#B8B8C5] mt-3">Crafting an unparalleled ecosystem for your next literary journey.</p>
          </motion.div>
          ...
          >
            {coreFeatures.map((feature, idx) => (
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-bold text-white m-0 tracking-tight">{feature.title}</h3>
                  <p className="text-sm text-[#B8B8C5] mt-2.5 leading-relaxed m-0">{feature.desc}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
